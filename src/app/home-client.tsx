      ...
      >
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm text-stone-400">
            ...
            <a href="/tools" className="hover:text-amber-400 transition-colors">{t("nav.freeTools")}</a>
      ...
      {mobileNav && (
        ...
        >
          <nav className="flex flex-col px-6 py-4 gap-3 text-sm text-stone-400">
            ...
            <a href="/tools" className="hover:text-amber-400 py-1">{t("nav.freeTools")}</a>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-stone-500">
                <li><a href="/tools" className="hover:text-amber-400 transition-colors">All free tools</a></li>
                ...
                <li><a href="/free-website-vulnerability-scanner" className="hover:text-amber-400 transition-colors">Vulnerability scanner</a></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-sm text-stone-500">
                ...
                <li><a href="/ai-app-security-scanner" className="hover:text-amber-400 transition-colors">AI app security</a></li>
                <li><a href="/vibe-coding-security" className="hover:text-amber-400 transition-colors">Vibe coding security</a></li>
                <li><a href="/answer-engine-optimization" className="hover:text-amber-400 transition-colors">AEO guide</a></li>
                <li><a href="/rss.xml" className="hover:text-amber-400 transition-colors">RSS</a></li>
