        ...
        <form onSubmit={handleGenerate} className="mb-12">
          <div className="flex flex-col sm:flex-row gap-3">
            <input
              ...
              className="flex-1 px-4 py-3 rounded-lg bg-white/5 border border-white/10 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500/50 transition-all"
            />
            <button
              type="submit"
