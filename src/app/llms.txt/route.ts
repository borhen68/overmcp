...
- $5: full report + fixes + GitHub PR
- $19: full report + fixes + auto-deploy + rescan monitoring

## Links

- Homepage: https://www.overmcp.com
- Dashboard: https://www.overmcp.com/dashboard
- Connect platforms: https://www.overmcp.com/connect
`;
